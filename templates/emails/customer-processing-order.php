...
// Check if the order total exceeds $200
if ( $order->get_total() >= 200 ) {
    // Add your PDF file path here
    $pdf_file_path = 'https://ky.easyshopusa.com/wp-content/uploads/2023/11/Credit-Card-Authorization-Form.pdf';
    
    echo '<p><a href="' . esc_url( $pdf_file_path ) . '">Download Card Auth Form</a></p>';
