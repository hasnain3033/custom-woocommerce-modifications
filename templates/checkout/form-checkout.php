...
<form name="checkout" method="post" class="checkout woocommerce-checkout cust-woocommerce-checkout" action="<?php echo esc_url( wc_get_checkout_url() ); ?>" enctype="multipart/form-data">
